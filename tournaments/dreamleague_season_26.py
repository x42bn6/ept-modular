...
class DreamLeagueSeason26:
    ...
    def build(self) -> Tuple[EptTournamentBase, EptStageBase, EptStageBase]:
        ...
        dl_s26_gs1.team_can_finish_between("Nigma Galaxy", 1, 10)
        dl_s26_gs1.team_can_finish_between("BetBoom Team", 1, 16)
        dl_s26_gs1.team_can_finish_between("Shopify Rebellion", 1, 14)
        dl_s26_gs1.team_can_finish_between("BOOM Esports", 1, 16)
        dl_s26_gs1.team_can_finish_between("Team Liquid", 1, 16)
        dl_s26_gs1.team_can_finish_between("Xtreme Gaming", 1, 16)
        dl_s26_gs1.team_can_finish_between("OG.LATAM", 1, 16)

        dl_s26_gs1.team_can_finish_between("PARIVISION", 1, 12)
        dl_s26_gs1.team_can_finish_between("Talon Esports", 1, 16)
        dl_s26_gs1.team_can_finish_between("Yakult Brothers", 1, 16)
        dl_s26_gs1.team_can_finish_between("Gaimin Gladiators", 1, 16)
        dl_s26_gs1.team_can_finish_between("NAVI Junior", 1, 16)
        dl_s26_gs1.team_can_finish_between("Team Falcons", 1, 16)
        dl_s26_gs1.team_can_finish_between("AVULUS", 1, 16)
        dl_s26_gs1.team_can_finish_between("Edge (team)", 1, 16)
