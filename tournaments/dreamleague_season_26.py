...
class DreamLeagueSeason26:
    ...
    def build(self) -> Tuple[EptTournamentBase, EptStageBase, EptStageBase]:
        ...
        dl_s26_gs2.team_can_finish_between("PARIVISION", 1, 3)
        dl_s26_gs2.team_can_finish_between("BetBoom Team", 1, 5)
        dl_s26_gs2.team_can_finish_between("Talon Esports", 1, 5)
        dl_s26_gs2.team_can_finish_between("Aurora Gaming", 2, 7)
        dl_s26_gs2.team_can_finish_between("Gaimin Gladiators", 2, 7)
        dl_s26_gs2.team_can_finish_between("Yakult Brothers", 4, 8)
        dl_s26_gs2.team_can_finish_between("Nigma Galaxy", 4, 8)
        dl_s26_gs2.team_can_finish_between("Team Liquid", 6, 8)
