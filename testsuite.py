...
from stage import Root, GroupStage, Tournament, PairGroupStage
...
def pair_group_stage_into_single_group_stage():
    ...
    for team in team_database.get_all_teams():
        ...
        add_optimisation_constraints(model, team, team_database, teams, total_points)
...
def add_optimisation_constraints(model, team, team_database, teams, total_points):
